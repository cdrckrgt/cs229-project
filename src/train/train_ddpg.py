...
from util import OrnsteinUhlenbeckNoise, soft_update
...
config = {
    ...
    'lr_Q' : 1e-3,
    'batch_size' : 128,
    'target_update' : 5e-3, # soft updates
    'memory_size' : int(1e5),
...
class Critic(nn.Module):
    def __init__(self):
        ...
        self.q1_fc3 = nn.Linear(384, 256)
        self.q1_act3 = nn.ReLU()
    ...
    def forward(self, obs, action):
        ...
        out1 = self.q1_act2(self.q1_fc2(obs))
        out1 = self.q1_act3(self.q1_fc3(obs))
        out1 = self.q1_fc4(obs)
